    ...
    <div class="modal-dialog modal-dialog-centered modal-simple modal-lg">
        <div class="modal-content p-3 p-md-5">
            <div class="modal-body">
                ...
                <form id="addIUJKForm" class="row g-3">
                    <div class="col-12">
                        <input type="text" class="form-control" name="modalAddIujkDocumentData" id="modalAddIujkDocumentData" required>
                    </div>
                    <div class="col-12">
                        <label class="form-label w-100" for="modalAddIujkExpireDate">Masa Berlaku Izin Usaha Jasa Konstruksi</label>
                        <input type="text" id="modalAddIujkExpireDate" name="modalAddIujkExpireDate" class="form-control" placeholder="YYYY-MM-DD" />
                    </div>
