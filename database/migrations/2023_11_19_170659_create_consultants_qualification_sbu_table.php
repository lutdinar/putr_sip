...
class CreateConsultantsQualificationSbuTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('consultants_qualification_sbu', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('consultants_qualification_sbu');
    }
}
