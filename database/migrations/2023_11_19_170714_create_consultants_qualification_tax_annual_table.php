...
class CreateConsultantsQualificationTaxAnnualTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('consultants_qualification_tax_annual', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('consultants_qualification_tax_annual');
    }
}
