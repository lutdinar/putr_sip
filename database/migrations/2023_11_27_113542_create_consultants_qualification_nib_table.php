...
class CreateConsultantsQualificationNibTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('consultants_qualification_nib', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('consultants_qualification_nib');
    }
}
